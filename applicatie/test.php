...
$query = 'select p.order_id as id, p.client_username as naam, p.address as adres from Pizza_Order as p';

$data = $db->query($query);

$html_table = '<table>';
$html_table = $html_table . '<tr><th>Id</th><th>Naam</th><th>Adres</th></tr>';
...
while($rij = $data->fetch()) {
  ...
  $html_table = $html_table . "<tr><td>$id</td><td>$naam</td><td>$adres</td></tr>";
}
